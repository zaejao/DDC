                      ...
                      <div class="col-11 mx-auto" >
												...
												<form class="form form-horizontal">
													<div class="form-body">
														...
														<h4 class="form-section"><i class="ft-clipboard"></i>  เพิ่มป้ายประชาสัมพันธ์ </h4> 
														...
														<input id="news_menu" type="hidden" class="form-control" name="news_menu" value="<?php echo $newsmenu ?>" value="">
														...
														<div class="form-group row">
															...
															<div class="col-md-4">
																...
																if($_GET['menu'] =="mbanner"){
																	?>
																	<div class="img_center">
																		<img class="disease_pic"  id="picture_disp"  src="" style="height:400px;width:660px;"   id="picture_disp" onerror="this.onerror=null;this.src='<?php echo $path['news'].'logo_df2.jpg';?>';" >
																	</div>
																	<br> 
																	<span class="danger"> Recommend : Max Size 6 MB, File Support: (.jpg, .png กว้าง 1500x สูง905px)  </span> 
																	<?php
																}else{
																	?>
																				<div class="img_center">
																					<img class="disease_pic"  id="picture_disp"  src="" style="height:470px;width:350px;"   id="picture_disp" onerror="this.onerror=null;this.src='<?php echo $path['news'].'logo_df3.jpg';?>';" >
																			</div>
																			<br> 
																			<span class="danger"> Recommend : Max Size 6 MB, File Support: (.jpg, .png  กว้าง 350px  สูง 470px ) </span> 
														...
														<div class="form-group row">
															...
															<div class="col-md-6"> 
																<div class="row skin skin-square-orange ml-2">
																	...
																	<input class="form-check-input mr-1" type="radio" name="news_main" id="news_main1" value="1" checked >
																	<label class="form-check-label ml-1" for="news_main1">ใช่</label>
																	</div>
																	<div class="form-check form-check-inline mr-5">
																	<input class="form-check-input mr-1" type="radio" name="news_main" id="news_main2" value="0"  >
														...
														<div class="form-group row">
															...
															<div class="col-md-6"> 
																<div class="row skin skin-square-orange ml-2">
																	<div class="form-check form-check-inline mr-5">
																	<input class="form-check-input mr-1 news_timeline" type="radio" name="news_timeline" id="news_timeline1" value="1"  >
																	<label class="form-check-label ml-1" for="news_timeline1">ใช้งาน</label>
																	</div>
																	<div class="form-check form-check-inline mr-5">
																	<input class="form-check-input mr-1 news_timeline" type="radio" name="news_timeline" id="news_timeline2" value="0" checked  >
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <div class="modal-center">
              ...
              <button type="button" class="btn btn-outline-info"  onclick="office.CreateNewsSD('<?php echo $dataid;?>');" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
