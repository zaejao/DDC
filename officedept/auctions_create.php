                      ...
                      <div class="col-11 mx-auto" >
												...
												<form class="form form-horizontal">
													<div class="form-body">
														...
														<h4 class="form-section"><i class="ft-clipboard"></i> เพิ่ม<?php echo $menuname ." || ".$auctions_type_code['auctions_type_th'] ." : ". $dataset['auctions_type_code'] ;?>   </h4> 
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <div class="modal-center">
              ...
              <button type="button" class="btn btn-outline-info"  onclick="office.CraeteAuctions();" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
