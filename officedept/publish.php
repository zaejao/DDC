				  ...
				  <div class="card">
					<div class="card-head">
					  <div class="card-header"> 
							<a href="publish_create.php?<?php echo 	$news_typecode;?>"  class="btn btn-info btn-sm"><i class="ft-plus white"></i> เพิ่ม <?php echo $menuname;?> </a>
					...
					<div class="card-content">
					  <div class="card-body"> 
							<div class="table-responsive">
									...
									?>
										<tr >
											...
											<td class="text-center"> 
												...
												<a href="javascript:contents.callModalDelete('news','<?php echo $val1['id'];?>','<?php echo $val1['news_title_th']; ?>','publish.php?<?php echo $news_typecode;?>');" class=" btn btn-icon btn-sm btn-danger" title="ลบ"><i class="fa fa-trash"></i>  </a>
								...
								<form id="form_set" method="post" action="publish_edit.php">
