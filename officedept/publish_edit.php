                      ...
                      <div class="col-11 mx-auto" >
												...
												<form class="form form-horizontal">
													<div class="form-body">
														...
														<h4 class="form-section"><i class="ft-clipboard"></i> แก้ไข<?php echo $menuname;?> </h4> 
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <div class="modal-center">
              ...
              <button type="button" class="btn btn-outline-info"  onclick="office.EditPublish('<?php echo $dataid;?>');" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
