...
?>
  ...
  <div class="app-content content">
    <div class="content-wrapper">
		...
		<?php // echo "<pre>".print_r($disease_detail,true)."</pre>" ;?>
                      ...
                      <div class="col-10 mx-auto" >
												...
												<form class="form form-horizontal">
													<div class="form-body">
														...
														<h4 class="form-section"><i class="ft-clipboard"></i> แก้ไขรายชื่อโรค </h4>
														...
														<div class="form-group row">
															...
															<div class="col-md-6">
																	...
																	<?php 
																		...
																		?>
																			<option value="<?php echo $val_d['department_code_ch'];?>" <?php if($val_d['department_code_ch']==$disease['department_code_ch']){ echo "selected";}?> disabled>  <?php echo $val_d['department_name_th'];?></option>
																		<?php 
																			}
																		} 
																		?>
												...
												<input type="hidden" id="numh" value="<?php echo $numh;?>" >
															<!--                             
																...
																<div class="form-row">
																	<div class="col-12">
																		<div class="form-group">
																			<label>ชื่อโรคภาษาอังกฤษ</label>
																			<input id="disease_name_en" type="text" class="form-control" name="disease_name_en" value="<?php echo $disease['disease_name_en'] ?>" placeholder="ชื่อโรคภาษาอังกฤษ">
																	</div>
																	</div>
																</div>  
																...
																<div class="row">
																	<div class="form-group col-12 mb-2">
																		<label for="eventRegInput1"> หน่วยงาน  <?php echo $disease['department_code_ch'] ;?></label> 
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <div class="modal-center">
              ...
              <button type="button" class="btn btn-outline-info"  onclick="office.EditDisease('<?php echo $dataid;?>');" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="../app-assets/js/scripts/forms/select/form-select2.js" type="text/javascript"></script>
	...
	{	
		var path_upload = '../uploads/summernote_temp';
