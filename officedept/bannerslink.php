<?php
  ...
  include "../gates/func.php";
	...
	$banners = $clsoffice->Load('banners',array('deleted'=>0 ,'department_code_ch'=>$_SESSION['deptcode']),'  orderby DESC  ','');
								...
								<table id="tbdata1" class="table table-white-space  table-middle table-hover">
									...
									?>
										<tr >
											...
											<td> <img src="<?php echo $path['bannerlink'].$val1['pathpic']; ?>" style=" height:40px;"> <?php //echo $val1['pathpic']; ?> </td>
											...
											<td>  
												<fieldset>
													<input type="checkbox" class="switchBootstrap" id="enable<?php echo $val1['id']?>" data-on-text="On"  data-off-text="Off" data-on-color="success"  <?php if( $val1['enable'] == "Y" ){ echo " checked " ; }?>  onchange="office.callSetEnable('banners','<?php echo $val1['id']?>','enable');"  />
												</fieldset>
											</td> 
											<td class="text-center"> 
												<a href="javascript:office.CallModalEditBanners('<?php echo $val1['id']; ?>');" class="btn btn-icon btn-sm btn-warning" > <i class="fa fa-edit"></i>  แก้ไข </a> 
												<a href="javascript:contents.callModalDelete('banners','<?php echo $val1['id'];?>','ป้ายแบนเนอร์','bannerlink.php');" class=" btn btn-icon btn-sm btn-danger"><i class="fa fa-trash"></i> ลบ </a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-info" onclick="office.CreateBanners();">
	...
	<div class="modal fade text-left" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" style="display: none;" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">ยกเลิก</button>
					<button type="button" class="btn btn-info" onclick="office.EditBanners();">
