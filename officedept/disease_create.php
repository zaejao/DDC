														...
														<div class="form-group row">
															...
															<div class="col-md-6">
																	...
																	<?php 
																		...
																		?>
																			<option value="<?php echo $val_d['department_code_ch'];?>" <?php if($val_d['department_code_ch']==$_SESSION['deptcode']){ echo "selected";}?> disabled>  <?php echo $val_d['department_name_th'];?></option>
																		<?php 
																			}
																		} 
																		?>
