...
$newsdata = $clscont->Load('news_mapping',array( 'type' =>'news_calendar','office'=>$deptcode,'enable_th'=>'Y' ),' datetime DESC ','');
...
<body>
  ...
  <?php include $pathf."/prepare_bannermain".$depttype.".php";?>
    ...
    $( document ).ready(function() {
        //dept.LoadNewsmass();
        contents.LoadCountNewsAuctOffice('ALL','news_activity' ,1 ,10); 
