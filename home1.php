...
include $pathf."/gates/func.php";
  ...
  $data_newsmain = $clscont->Load('news_mapping',array( 'office'=> $deptcode, 'type' => 'news_mass', 'enable_th'=>'Y' ),' datetime DESC ','');
...
<body>
  ...
  <!-- ############################################################################################################### -->
  <?php include "prepare_bannermain1.php";?>
<!-- /////////////////////// รูป ข้างบน และข้างๆ ////////////////////// -->
...
<section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-12 mt-3">
                    <div class="box-img2">
                        <a href="#"> <img src="img/stethoscope-doctor-medical-blood-pressure-161489.png" alt="Avatar" class="image"></a> 
                    </div>   <!--/.container -->
                </div><!-- /.col-12 -->
            </div><!-- /.row col-4 -->
...
<section>
    ...
    <div class="row mt-3">
        <div id="column-slide" class="col-lg-4">
          <img src="img/pexels-photo-207381.png" alt="Snow" style="width:100%">
        </div>
        <div id="column-slide" class="col-lg-4">
          <img src="img/pexels-photo-207381.png" alt="Forest" style="width:100%">
        </div>
        <div id="column-slide" class="col-lg-4">
          <img src="img/pexels-photo-207381.png" alt="Mountains" style="width:100%">
        </div>
      </div>
    ...
    <div class="row my-5">
        ...
        <div  class="col-lg-6">
            <div id="image-left" class="row"> 
              <img src="img/pexels-photo-1282308-left.png">
          </div>
       </div> <!-- col-lg-6 -->
