<?php
  ...
  include "../gates/func.php";
	...
	$data1 = $clsoffice->LoadOnce('menumain',array('id'=>	$dataid  ) );
						...
						<form class="form form-horizontal">
							<div class="form-body">
										...
										<div class="col-md-9">
											<div class="row skin skin-square-orange ml-2">
												<div class="form-check form-check-inline mr-5">
													<input class="form-check-input mr-1" type="radio" name="menumain_linktype" id="menumain_linktype1" value="1" <?php  if($data1['menumain_linktype']=='1'){echo "checked";} ?>>
													<label class="form-check-label ml-1" for="menumain_linktype1">1 ลิงก์ภายนอก</label>
												</div>
												<div class="form-check form-check-inline mr-5">
													<input class="form-check-input mr-1" type="radio" name="menumain_linktype" id="menumain_linktype2" value="2" <?php  if($data1['menumain_linktype']=='2'){echo "checked";} ?>>
													<label class="form-check-label ml-1" for="menumain_linktype2">2 ลิงก์ภายใน</label>
												</div>
												<div class="form-check form-check-inline mr-5">
													<input class="form-check-input mr-1" type="radio" name="menumain_linktype" id="menumain_linktype3" value="3" <?php  if($data1['menumain_linktype']=='3'){echo "checked";} ?>>
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<input id="menumain_otherlink" type="text" class="form-control" name="menumain_otherlink" value="<?php echo $data1['menumain_otherlink'] ?>" placeholder="ลิงก์">
									</div>
								</div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <div class="modal-center">
              ...
              <button type="button" class="btn btn-outline-info"  onclick="office.EditMenuMain('<?php echo $dataid;?>');" >ยืนยัน</button>
            </div>
          </div>
        </div>
      </div>
