  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns"> 
    ...
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top   navbar-brand-center bg-menu navbar-dark bg-cyan" data-nav="brand-center">
            ...
            <ul class="nav navbar-nav float-right">
              <li class="dropdown dropdown-user nav-item">
                  ...
                  <span class="mr-1"> 
                   ...
                   <!--   ผู้ดูแลระบบระดับสำนัก (Admin) || 	 ศูนย์สารสนเทศ (itc) -->
                    <?php 
                    //echo $_SESSION['userposition'] ; ?> 
                    <?php  echo $_SESSION['usertypename'] ." || " .$_SESSION['deptname'].$_SESSION['deptcode']  ;
                    //  $_SESSION['userid']."||".$_SESSION['usertypename']."||".
                    ?> 
                    </span> 
                  </span>
