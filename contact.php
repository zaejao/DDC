          ...
          <div class="col-12 mt-4"> 
            ...
            <div class="row">
              <div class="col-12 mb-4"> 
                <span class="topic_text   lang_contactdept"> ติดต่อกรม </span> 
              </div> 
            </div>

          <!--          
            <div class="row mt-4">
                <div class="contact_block1 col-sm-6">
                    <img class="img-responsive img_contact" src="<?php echo $path['others']; ?>map.jpg">
                </div>
                <div class="contact_block2 col-sm-6">
                  <img class="imgdetail_contact" src="img/logo3.png">
                  <p class="contact_h fontpink">กรมควบคุมโรค</p>
                  <p class="contact_d">ที่อยู่ : 88/21 ถนน ติวานนนท์ ตำบลตลาดขวัญ อำเภอเมือง จังหวัด นนทบุรี 11000</p>
                  <div class="container">
                    <div class="row">
                      <img class="col-lg-2" src="<?php echo $path['others']; ?>/tel.jpg" height="61">
                      <p class="contact_phone">สายด่วน : 1422</p>
                      <p class="contact_phone">โทรศัพท์ : 02-5903000</p>
                    </div>
                  </div> 
                  <div class="container">
                    <div class="row">
                    <img class="col-lg-2" src="<?php echo $path['others']; ?>/fax.jpg">
                      <p class="contact_phone"> แฟกซ์ : 02-5903000</p>
                    </div>
                  </div> 
                </div>  
            </div>
            ...
            <div class="row mt-4 pagecontact">
              <div class="col-md-6 col-sm-12 boxcont1 mb-3">  
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-9 mt-1  text-center">
                          <div class="text4 "> <span class="lang_deptdisease"> กรมควบคุมโรค </span> </div>
                          <div> 
                            <span class="lang_address"> ที่อยู่ </span> :  
                         ...
                         <div class="col-md-12 col-xl-6"> 
                          <div class="row">
                            ...
                            <div class="col-9 m-auto">
                              <span class="lang_hotline"> สายด่วน </span>: <b>1422</b>
                              <br>
                              <span class="lang_tel">โทรศัพท์ </span>: 02-5903000 
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12 col-xl-6"> 
                          <div class="row">
                            ...
                            <div class="col-9 m-auto ">
                              <span class="lang_fax">แฟกซ์ </span> : 02-5903000  
                            </div>
                          </div> 
                        </div>
                      </div>
              ...
              <div class="col-md-6 col-sm-12 boxcont2"> 
                ...
                <button class="btn btnmap btn_green " >
                  <span class="fa fa-map-o"></span>     <span class="lang_graphicmap"> แผนที่กราฟฟิค </span>
                </button>  
